<template>
  <nav
    class="top-0 fixed z-50 w-full flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg bg-current"
  >
    <div
        ...
        <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
          ...
          <li class="flex items-center">
            <a
              ...
              href="#"
            >
              <span class="inline-block ml-2">التبادل</span>
            </a>
          </li>
          ...
          <li class="flex items-center">
            <a
              ...
              href="#"
            >
              <span class="inline-block ml-2">الشراء</span>
            </a>
          </li>
          ...
          <li class="flex items-center">
            <a
              ...
              href="#"
            >
              <span class="inline-block ml-2">تواصل معنا</span>
            </a>
          </li>
          ...
          <li class="flex items-center">
            <button
              ...
              type="button"
            >
              <i class="fas fa-arrow-alt-circle-down"></i> سجل مجانا
            </button>
          </li>
        </ul>
      </div>
